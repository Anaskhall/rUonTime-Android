...
public class GroupsBean {
	...
	public void init(){
		...
		source.add(new User("firstUser", "firstName", "lastName", "1"));
		source.add(new User("anotherUser", "fasdairstName", "zlagergerstName", "12"));
		source.add(new User("you", "firstdqwfwqName", "aaalastName", "21"));
